...
export default function App() {
  ...
  const [inventory, setInventory] = useState([
    { id: 1,  category: "펌제",     name: "일반펌 1제",         par: 4,  current: 3, fav: true },
    { id: 2,  category: "펌제",     name: "일반펌 2제(중화제)",  par: 4,  current: 2, fav: false },
    { id: 3,  category: "펌제",     name: "볼륨매직 1제",        par: 3,  current: 2, fav: false },
    { id: 4,  category: "펌제",     name: "볼륨매직 2제",        par: 3,  current: 3, fav: false },
    { id: 5,  category: "염모제",   name: "새치커버 자연갈색",    par: 6,  current: 5, fav: true },
    { id: 6,  category: "염모제",   name: "패션컬러 애쉬",       par: 6,  current: 2, fav: false },
    { id: 7,  category: "염모제",   name: "패션컬러 브라운",      par: 6,  current: 4, fav: false },
    { id: 8,  category: "탈색제",   name: "탈색 파우더",         par: 3,  current: 2, fav: true },
    { id: 9,  category: "산화제",   name: "산화제 6%",           par: 4,  current: 1, fav: true },
    { id: 10, category: "산화제",   name: "산화제 9%",           par: 3,  current: 2, fav: false },
    { id: 11, category: "산화제",   name: "산화제 3%",           par: 3,  current: 2, fav: false },
    { id: 12, category: "클리닉",   name: "시술용 클리닉 앰플",    par: 30, current: 22, fav: true },
    { id: 13, category: "클리닉",   name: "단백질 트리트먼트",     par: 3,  current: 1, fav: false },
    { id: 14, category: "클리닉",   name: "두피 스케일링제",      par: 2,  current: 1, fav: false },
    { id: 15, category: "매장소모품", name: "백바용 샴푸",        par: 4,  current: 3, fav: true },
    { id: 16, category: "매장소모품", name: "백바용 린스",        par: 3,  current: 1, fav: false },
    { id: 17, category: "매장소모품", name: "펌지",              par: 4,  current: 2, fav: false },
    { id: 18, category: "매장소모품", name: "염색용 호일",        par: 6,  current: 5, fav: false },
    { id: 19, category: "매장소모품", name: "일회용 비닐장갑",     par: 8,  current: 6, fav: true },
    { id: 20, category: "매장소모품", name: "비닐캡",            par: 5,  current: 1, fav: false },
    { id: 21, category: "점판용",   name: "홈케어 샴푸",         par: 10, current: 7, fav: false },
    { id: 22, category: "점판용",   name: "홈케어 트리트먼트",     par: 10, current: 3, fav: false },
    { id: 23, category: "점판용",   name: "데일리 헤어 에센스",    par: 8,  current: 6, fav: false },
  ]);
  ...
  useEffect(() => {
    const unsub = onSnapshot(doc(db, "salon", "main"), (snap) => {
      if (snap.exists()) {
        ...
        if (data.inventory)    setInventory(data.inventory.map(migrateInvItem));
  ...
  }, [members, log, zoneAssign, zoneDone, rotationDate, thanks, events, birthdays, moods, orders, suggestions, timeBank, reviewDone, instaUploads, personalPurchases, importantMemos, luckyPrizes, luckyTickets, luckyClaimed, luckyWins, inventory, orderMemo, isLoaded]);
