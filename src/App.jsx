...
export default function App() {
    ...
    saveTimerRef.current = setTimeout(async () => {
      try {
        await setDoc(doc(db, "salon", "main"), {
          ...
          reviewDone, instaUploads, personalPurchases, importantMemos, gratitudes,
  ...
  }, [members, log, zoneAssign, zoneDone, rotationDate, thanks, events, birthdays, moods, orders, suggestions, timeBank, reviewDone, instaUploads, personalPurchases, importantMemos, gratitudes, luckyPrizes, luckyTickets, luckyClaimed, luckyWins, isLoaded]);
                    ...
                    <div style={{ display: "flex", gap: 6, marginBottom: 6 }}>
                      <div style={{ flex: 1, position: "relative" }}>
                        <input type="date" value={eventDraft.date}
                          ...
                          style={{ width: "100%", border: `1px solid ${C.line}`, borderRadius: 10, padding: "9px 11px", fontSize: 12, background: C.bg, outline: "none", color: eventDraft.date ? C.ink : "transparent" }} />
                        {!eventDraft.date && (
                          <span style={{
                      ...
                      <div style={{ flex: 1, position: "relative" }}>
                        <input type="time" value={eventDraft.time}
                          ...
                          style={{ width: "100%", border: `1px solid ${C.line}`, borderRadius: 10, padding: "9px 11px", fontSize: 12, background: C.bg, outline: "none", color: eventDraft.time ? C.ink : "transparent" }} />
                        {!eventDraft.time && (
                          <span style={{
                            position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)",
                            fontSize: 12, color: C.muted, pointerEvents: "none",
