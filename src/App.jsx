...
export default function App() {
  ...
  const [salesDraft, setSalesDraft] = useState({ amount: "", store: "", prepaid30: "", prepaid50: "", prepaid80: "" });
                              ...
                              <button key={d}
                                ...
                                onClick={() => {
                                  ...
                                  if (rec) {
                                    ...
                                    setSalesDraft({ amount: "", store: "", prepaid30: "", prepaid50: "", prepaid80: "" });
                                  }
                                }}
                                style={{
                  ...
                  {!isJangnim && (() => {
                    ...
                    <div className="card" style={{
                      ...
                      <button onClick={() => {
                        ...
                        if (amount + store + prepaid === 0 && !targetRec) {
                          showToast("입력한 매출이 없어요", "err"); return;
                        }
                        setSales(p => [
                          ...p.filter(s => !(s.memberId === myId && s.date === targetISO)),
                          { id: Date.now(), memberId: myId, date: targetISO,
                            amount, store, prepaid, p30, p50, p80 },
                        ]);
                        setSalesDraft({ amount: "", store: "", prepaid30: "", prepaid50: "", prepaid80: "" });
                        setSalesDate("");
