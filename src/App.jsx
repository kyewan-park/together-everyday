...
export default function App() {
  ...
  }, [members, log, zoneAssign, zoneDone, rotationDate, thanks, events, birthdays, moods, orders, suggestions, timeBank, reviewDone, instaUploads, personalPurchases, importantMemos, isLoaded]);
                  ...
                  {members.map(m => {
                    ...
                    return (
                      <div key={m.id} style={{
                        ...
                        {/* 내 카드 = 입력 가능 (펼쳤을 때만, 대표 아닐 때만), 다른 멤버 = 보기만 */}
                        {isMe && !isOwner && myCardExpanded ? (
                          <>
                            {/* 1. 내 상태 변경 버튼 */}
                            <div style={{
                          ...
                          <div
                            onClick={() => { if (isMe && !isOwner) setMyCardExpanded(true); }}
                            style={{
                            ...
                            {memberMood ? (
                              ...
                              <div style={{
                                fontSize: 10, color: (isMe && !isOwner) ? C.sage : C.muted, fontStyle: "italic",
                                textAlign: "center", padding: "4px",
                              }}>
                                {(isMe && !isOwner) ? "✏️ 눌러서 컨디션 체크하기" : "💗 아직 컨디션 체크 전"}
                              </div>
                            )}
                            {memberMood?.note && (
                              <div style={{
