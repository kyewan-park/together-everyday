...
export default function App() {
  ...
  }, [members, log, zoneAssign, zoneDone, rotationDate, thanks, events, birthdays, moods, orders, suggestions, timeBank, reviewDone, instaUploads, personalPurchases, importantMemos, luckyPrizes, luckyTickets, luckyClaimed, luckyWins, isLoaded]);
                          ...
                          <>
                            ...
                            <div style={{
                              ...
                              <button onClick={() => {
                                ...
                                giveLuckyTicket(`${myId}-${today}-mood`, 1, "오늘 컨디션 체크");
                                showToast("컨디션 체크 완료 💗");
                              }} style={{
                  ...
                  {!isJangnim && <div className="card" style={{
                    ...
                    <button onClick={() => {
                      ...
                      if (cur.includes(myId)) {
                        ...
                        giveLuckyTicket(`${myId}-${todayKey}-review`, 1, "오늘 리뷰 완료");
                        showToast("리뷰 답글 완료! 💛");
                      }
                    }} style={{
                      width: "100%",
