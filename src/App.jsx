                    ...
                    return (
                      <div className="card" style={{
                        ...
                        <div style={{ fontSize: 10, color: C.muted, marginBottom: 12, lineHeight: 1.5 }}>
                          ...
                          <span style={{ color: C.roseDeep, fontWeight: 700 }}>🔴 빨강 = 미입력</span> · <span style={{ color: C.sageDeep, fontWeight: 700 }}>🟢 초록 = 입력됨</span>
                        </div>
                  ...
                  {!isJangnim && (() => {
                    ...
                    <div className="card" style={{
                      ...
                      <button onClick={() => {
                        ...
                        if (amount + store + prepaid === 0) { showToast("입력한 매출이 없어요", "err"); return; }
                        setSales(p => [
