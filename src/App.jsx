...
export default function App() {
    ...
    saveTimerRef.current = setTimeout(async () => {
      try {
        await setDoc(doc(db, "salon", "main"), {
          ...
          inventory, orderMemo, gratitudes, sales,
  ...
  }, [members, log, zoneAssign, zoneDone, rotationDate, thanks, events, birthdays, moods, orders, suggestions, timeBank, reviewDone, instaUploads, personalPurchases, importantMemos, luckyPrizes, luckyTickets, luckyClaimed, luckyWins, inventory, orderMemo, gratitudes, sales, rotationStart, autoRotate, isLoaded]);
